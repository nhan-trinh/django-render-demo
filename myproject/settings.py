...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            BASE_DIR / 'store' / 'templates',  # Thêm dòng này
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LANGUAGE_CODE = 'vi'  # hoặc 'en-us' tùy mặc định
...
ALLOWED_HOSTS = ['nhan1111.pythonanywhere.com'] # Temporarily allow all hosts, replace with your actual domain later
...
INSTALLED_APPS = [
    ...
    'django.contrib.messages',
    'django.contrib.staticfiles',
    'store',  # Add the missing comma here
]
